...
test_int : test_int.c test_int.h DataStructures/gen_red_black_tree.c DataStructures/gen_red_black_tree.h int_type.h
	$(CC) $(CFLAGS) -D TYPEFILE=\"../int_type.h\" -o test_int test_int.c DataStructures/gen_red_black_tree.c
